...
bool e_elements::begin_child_ex(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags)
{
    ...
    parent_window->DrawList->AddRectFilledMultiColorRounded(parent_window->DC.CursorPos, parent_window->DC.CursorPos + ImVec2(size.x , 32), ImColor(24, 24, 26), ImColor(50, 50, 50), ImColor(50, 50, 50), ImColor(50, 50, 50), ImColor(50, 50, 50), 4.0f, ImDrawCornerFlags_TopLeft);
    parent_window->DrawList->AddText(menu::get_instance()->bold, 15.0f, parent_window->DC.CursorPos + ImVec2(16, 9), ImColor(250,250,250), name);
...
bool e_elements::begin_child(const char* str_id, const ImVec2& size_arg, bool border, ImGuiWindowFlags extra_flags)
{
    ...
    PushStyleVar(ImGuiStyleVar_ItemSpacing, ImVec2(4, 11));
